package com.hpl.springframework.beans.factory.xml;
...
import com.hpl.springframework.beans.factory.support.AbstractBeanDefinitionReader;
import com.hpl.springframework.beans.factory.support.BeanDefinitionRegistry;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, BeansException {
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            if(!ObjectUtil.isEmpty(beanScope)) {
